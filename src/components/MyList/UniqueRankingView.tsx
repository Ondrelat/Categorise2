          ...
          return (
            <div key={rank} className="flex items-center gap-4">
              ...
              <div className="shrink-0">
                <div className="w-12 h-12 bg-linear-to-r from-blue-500 to-purple-600 text-white rounded-full flex items-center justify-center text-lg font-bold shadow-lg">
                  {rank}
                </div>
              </div>
              {/* Zone de drop */}
